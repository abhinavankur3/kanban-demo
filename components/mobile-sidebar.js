...
export default function MobileSidebar() {
  ...
  return (
    <>
      <button onClick={() => setIsOpen(true)} className="mr-4 rounded-md p-2 hover:bg-accent">
        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-background/80 backdrop-blur-sm">
          <div className="mt-16 w-full max-w-sm rounded-lg border border-border bg-card p-6 shadow-lg">
            <div className="mb-6 flex items-center justify-between">
              <h2 className="text-xl font-bold">All Boards ({boards.length})</h2>
              <button onClick={() => setIsOpen(false)} className="rounded-full p-2 hover:bg-accent">
                &times;
              </button>
            </div>
